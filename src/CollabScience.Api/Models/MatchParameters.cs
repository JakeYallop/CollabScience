...
public class MatchParameters
{
    ...
    {
        AreasOfInterest = (areasOfInterest ?? Array.Empty<string>()).ToHashSet(StringComparer.OrdinalIgnoreCase);
        Equipment = (equipment ?? Array.Empty<string>()).ToHashSet(StringComparer.OrdinalIgnoreCase);
        Expertise = (expertise ?? Array.Empty<string>()).ToHashSet(StringComparer.OrdinalIgnoreCase);
